export const CATEGORY_IMAGES: Record<string, string[]> = {
  "Tentoonstelling": [
    ...
    "https://images.unsplash.com/photo-1531243625752-c0eb5e6fbaf0?q=80&w=1000",
  ...
  "Voorstelling": [
    ...
    "https://images.unsplash.com/photo-1585554985019-1b49e037d8d7?q=80&w=1000",
    "https://images.unsplash.com/photo-1499781350541-7783f6c6a0c8?q=80&w=1000",
    "https://images.unsplash.com/photo-1522158637959-30385a09e0da?q=80&w=1000",
  ],
  "Activiteit": [
  ...
  "Markt & Beurs": [
    ...
    "https://images.unsplash.com/photo-1519671282429-b44660ead0a7?q=80&w=1000",
    ...
    "https://images.unsplash.com/photo-1601598851547-4302969d0614?q=80&w=1000",
    "https://images.unsplash.com/photo-1551024506-0bccd828d307?q=80&w=1000",
    "https://images.unsplash.com/photo-1548535562-4c2c13d8d5e5?q=80&w=1000",
  ],
  "Quiz & Spelletjes": [
    ...
    "https://images.unsplash.com/photo-1629904853893-c2c8981a1dc5?q=80&w=1000",
    "https://images.unsplash.com/photo-1585504198199-20277593b94f?q=80&w=1000",
    "https://images.unsplash.com/photo-1611996575749-79a3a250f948?q=80&w=1000",
    "https://images.unsplash.com/photo-1553481187-be93c21490a9?q=80&w=1000",
    "https://images.unsplash.com/photo-1566378246598-5b11a0d486cc?q=80&w=1000",
  ],
  "Leren & Ontdekken": [
...
const SUBCATEGORY_KEYWORDS: Record<string, { category: string; keywords: string[] }[]> = {
  "Tentoonstelling": [
    { category: "museum", keywords: ["museum", "musea"] },
    { category: "galerie", keywords: ["galerie", "gallery", "expositie"] },
    { category: "kunst", keywords: ["schilderij", "beeldhouw", "kunstwerk", "vernissage"] },
  ],
  "Voorstelling": [
    { category: "concert", keywords: ["concert", "livemuziek", "optreden", "band", "orkest", "zang", "dj", "jazz", "piano", "gitaar"] },
    { category: "theater", keywords: ["theater", "toneel", "musical", "dans", "ballet", "cabaret"] },
    { category: "film", keywords: ["film", "cinema", "bioscoop", "movienight"] },
  ],
  "Activiteit": [
    { category: "sport", keywords: ["voetbal", "tennis", "basketbal", "hardlopen", "marathon"] },
    { category: "fietsen", keywords: ["fietsen", "cycling", "wielrennen", "bike"] },
    { category: "wandelen", keywords: ["wandeling", "wandelen", "speurtocht", "natuur"] },
    { category: "kinderen", keywords: ["kinder", "kinderfeest", "kids"] },
  ],
  "Stappen & Borrel": [
    { category: "festival", keywords: ["festival", "kermis", "carnaval"] },
    { category: "feest", keywords: ["feest", "party", "verjaardag"] },
    { category: "borrel", keywords: ["borrel", "bar", "kroeg", "drinks"] },
  ],
  "Markt & Beurs": [
    { category: "markt", keywords: ["markt", "braderie", "rommelmarkt"] },
    { category: "beurs", keywords: ["beurs", "fair", "trade show"] },
  ],
  "Quiz & Spelletjes": [
    { category: "quiz", keywords: ["pubquiz", "quiz", "trivia"] },
    { category: "spel", keywords: ["bingo", "bordspel", "spelletjes"] },
  ],
  "Leren & Ontdekken": [
    { category: "workshop", keywords: ["workshop", "cursus", "training"] },
    { category: "lezing", keywords: ["lezing", "presentatie", "seminar"] },
    { category: "rondleiding", keywords: ["rondleiding", "tour", "excursie"] },
  ],
  "Eten & Drinken": [
    { category: "restaurant", keywords: ["restaurant", "diner", "eten"] },
    { category: "foodfestival", keywords: ["foodfestival", "food truck", "proeverij"] },
    { category: "koken", keywords: ["koken", "bakken", "culinair"] },
  ],
};
...
export function getBestCategoryImage(category: string, title: string, description: string = ""): string {
  ...
  const subgroups = SUBCATEGORY_KEYWORDS[category];

  if (subgroups) {
    const scores: { groupIndex: number; score: number }[] = subgroups.map((group, index) => {
      const score = group.keywords.filter(kw => combinedText.includes(kw)).length;
      return { groupIndex: index, score };
    });
    scores.sort((a, b) => b.score - a.score);

    if (scores[0].score > 0) {
      const segmentSize = Math.floor(images.length / subgroups.length);
      const startIdx = scores[0].groupIndex * segmentSize;
      const endIdx = Math.min(startIdx + segmentSize, images.length);
      const segment = images.slice(startIdx, endIdx);
      if (segment.length > 0) {
