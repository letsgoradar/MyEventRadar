...
const themes: Theme[] = [
  {
    id: "white-orange",
    name: "Wit met Oranje",
    description: "Lichte basis met oranje accenten",
    colors: ["#f5f5f5", "#e8e8e8", "#fb923c", "#fdba74", "#fed7aa"],
    textColor: "#1a1a1a",
  },
  {
    id: "white-blue",
    name: "Wit met Blauw",
    description: "Lichte basis met blauwe accenten",
    colors: ["#f5f5f5", "#e8e8e8", "#3b82f6", "#60a5fa", "#93c5fd"],
    textColor: "#1e3a5f",
  },
  {
    id: "white-green",
    name: "Wit met Groen",
    description: "Lichte basis met groene accenten",
    colors: ["#f5f5f5", "#e8e8e8", "#22c55e", "#4ade80", "#86efac"],
    textColor: "#14532d",
  },
  {
    id: "white-purple",
    name: "Wit met Paars",
    description: "Lichte basis met paarse accenten",
    colors: ["#f5f5f5", "#e8e8e8", "#a855f7", "#c084fc", "#d8b4fe"],
    textColor: "#3b0764",
  },
  {
    id: "white-pink",
    name: "Wit met Roze",
    description: "Lichte basis met roze accenten",
    colors: ["#f5f5f5", "#e8e8e8", "#ec4899", "#f472b6", "#f9a8d4"],
    textColor: "#831843",
  },
  {
    id: "white-teal",
    name: "Wit met Teal",
    description: "Lichte basis met teal accenten",
    colors: ["#f5f5f5", "#e8e8e8", "#14b8a6", "#2dd4bf", "#5eead4"],
    textColor: "#134e4a",
  },
  {
    id: "white-red",
    name: "Wit met Rood",
    description: "Lichte basis met rode accenten",
    colors: ["#f5f5f5", "#e8e8e8", "#ef4444", "#f87171", "#fca5a5"],
    textColor: "#7f1d1d",
  },
  {
    id: "white-amber",
    name: "Wit met Amber",
    description: "Lichte basis met amber accenten",
    colors: ["#f5f5f5", "#e8e8e8", "#f59e0b", "#fbbf24", "#fcd34d"],
    textColor: "#78350f",
  },
  {
    id: "pure-silver",
